    ...
    for(deviceIndex in devices)
        {
            ...
            deviceData += "<td> &nbsp; <i id = 'trashIcon' onClick='confirmDelete(\""+ device['MAC_Address'] +"\");' class='fas fa-trash '></i> &nbsp; &nbsp; </td>";
...
var deviceToDelete = null;

function confirmDelete(mac_address)
{
    console.log("confirm delete!!")
    deviceToDelete=mac_address;
    $("#myModal").show();
}
...
function deleteDevice()
{
    ...
    $.post("api/deleteDevice.php", { mac: deviceToDelete}).done(function(data) {
		if(data=="200 OK")
            {
               $("#myModal").hide(); 
            }
            ...
            if(device["Status"] == "")
                {
                    ...
                    deviceNotificationInfo+= "Date: " + device["LastSeen"];
